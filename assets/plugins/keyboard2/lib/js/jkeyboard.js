    ...
    Plugin.prototype = {
        ...
        events: function () {
            var letters = $(this.element).find('.letter'),
                ...
                No_key = $(this.element).find('.no'),
                Yes_key = $(this.element).find('.yes'),
                Chips_key = $(this.element).find('.chips'),
                Salad_key = $(this.element).find('.salad'),
                Bulgur_key = $(this.element).find('.bulgur'),
